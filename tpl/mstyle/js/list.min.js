...
$(".selectBtn").click(function() {
    ...
    if ($(this).hasClass("cur") && !$(this).parent().hasClass("fixed")) {
		...
		!scrollObj["letter_list"] && scrollTags.init("letter_list");
