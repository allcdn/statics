...
}(jQuery), qireuser.prototype.urls = new Array(Root + "index.php?s=/user/center/flushinfo"), qireuser.prototype.gu = function() {
...
$(document).ready(function() {
	$("#cmt-input-tip .ui-input").focus(function() {
		...
		$(this).click(function() {
			...
			hadpingfen > 0 ? ($.showfloatdiv({
				...
				txt: "数据提交中...",
				cssname: "loading"
			}), c.removeClass("active"), $("ul.rating li:lt(" + e + ")").addClass("active"), $("#ratewords").html(b), $.post(Root + "index.php?s=/home/ajax/addgold", {
				val: $(this).attr("val"),
				id: id,
				sid: sid				
			}, function(a) {
				...
				$.ajax({type: 'get',cache: false,url: Root + "index.php?s=/home/ajax/gold/id/" + id +"/sid/"+ sid,success:function(data){stars(data.gold);}});
				}
	...
	$.ajax({
		url: b.attr("data"),
		success: function(a) {
			$.hidediv(a), parseInt(a.code) > 0 && (2 == a.docode ? b.removeClass("ated").addClass("focus").html("+关注").attr("data", "/user-userdo-focususer-uid-" + b.attr("val")) : b.removeClass("focus").addClass("ated").html("已关注").attr("data", "/user-userdo-delfocus-uid-" + b.attr("val")), "function" == typeof getfocusuid && getfocusuid())
		},
		dataType: "json"
	})
