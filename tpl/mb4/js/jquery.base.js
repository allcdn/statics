...
$(function() {
	...
	$('#umbBtn li:last').addClass('ielast');
	$('.tagpic dd:last').addClass('dlast')
});

function responsive() {
if ($('body').width() > 1214) {
		$('.header_h').removeClass('ww564 ww745 ww1024 ww1214');
		$('.header_h').addClass('ww1214');
		$('.tab-a').removeClass('w564 w745 w1024 w1214');
		$('.tab-a').addClass('w1214');
		$('.tab-l').removeClass('w930 w745 w570 w564');
		$('.tab-l').addClass('w930');
		$('.player_zanpian ').removeClass('w900 w715 w864 w564');
		$('.player_zanpian ').addClass('w900');
		$('.tab-r,.play-bug').removeClass('wmax');
		$('.tab-r,.play-bug').addClass('wmax');
		$('.playurl').removeClass('w475 w570');
		
	} else if ($('body').width() > 1024) {
		$('.header_h').removeClass('ww564 ww745 ww1024 ww1214');
		$('.header_h').addClass('ww1024');
		$('.tab-a').removeClass('w564 w745 w1024 w1214');
		$('.tab-a').addClass('w1024');
		$('.tab-l').removeClass('w930 w745 w570 w564');
		$('.tab-l').addClass('w745');
		$('.player_zanpian ').removeClass('w900 w715 w864 w564');
		$('.player_zanpian ').addClass('w715');
		$('.tab-r,.play-bug').removeClass('wmax');
		$('.tab-r,.play-bug').addClass('wmax');
		$('.playurl').removeClass('w475 w570');
	} else if ($('body').width() > 860) {
		$('.header_h').removeClass('ww564 ww745 ww1024 ww1214');
		$('.header_h').addClass('ww745');
		$('.tab-a').removeClass('w564 w745 w1024 w1214');
		$('.tab-a').addClass('w745');
		$('.tab-l').removeClass('w930 w745 w570 w564');
		$('.tab-l').addClass('w745');
		...
		$('.player_zanpian ').addClass('w715');
		$('.tab-r,.play-bug').removeClass('wmax');
		$('.tab-r,.play-bug').addClass('wmin');
		$('.playurl').removeClass('w475 w570');
		$('.playurl').addClass('w570');
		
	}
		else if ($('body').width() < 760) {
		$('.header_h').removeClass('ww564 ww864 ww1024 ww1214');
		$('.header_h').addClass('ww564');
		$('.tab-a').removeClass('w564 w745 w1024 w1214');
		$('.tab-a').addClass('w564');
		$('.tab-l').removeClass('w930 w745 w570 w564');
		$('.tab-l').addClass('w564');
